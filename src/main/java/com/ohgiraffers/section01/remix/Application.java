...
public class Application {
        ...
        do {
            ...
            switch (no) {
                case 1:
                    ...
                    break;
                case 2:
                    categoryController.selectCategoryByCode(inputCategoryCode());
                    break;
                case 3:
                    categoryController.registCategory(inputCategory());
                    break;
                case 4:
                    categoryController.modifyCategory(inputModifyCategory());
                    break;
                case 5:
                    categoryController.deleteCategory(inputDeleteCategoryCode());
                    break;
                default:
                    System.out.println("잘못 된 카테고리 메뉴를 선택하셨습니다.");
            }
        } while (true);
    }
    ...
    private static Map<String, String> inputModifyCategory() {
        ...
        String name = sc.nextLine();
        System.out.print("수정할 카테고리 상위 코드를 입력하세요 : ");
        String refCategoryCode = sc.nextLine();
    ...
    private static Map<String, String> inputDeleteCategoryCode() {
        Scanner sc = new Scanner(System.in);
